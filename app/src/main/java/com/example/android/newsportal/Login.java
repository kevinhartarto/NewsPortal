...
public class Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (session) {
            Intent intent = new Intent(Login.this, MainActivity.class); //yang .class diganti ke class yang mau ditampilkan setelah Login
...
//                        editor.commit();
                        ...
                        Intent intent = new Intent(Login.this, MainActivity.class); //ganti yg .class ke kelas selanjutnya setelah Login
                        intent.putExtra(TAG_ID, id);
